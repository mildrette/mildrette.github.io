...
Contributed to the RelaySMS Android application by:

* Implementing frontend interfaces from Figma designs.
* Building UI using Kotlin and Jetpack Compose.
...
Contributed to the DekaSMS Android application with a focus on:
...
Contributed to LibSMSMMS through:
...
This portfolio is a personal project by **Mildred Fonka**.
